...
_screen addAction ["Update ATIS data", QUOTE([true, _this select 0] call FUNC(updateATISdata);), nil, 1.012, true, true, "", QUOTE(isClass (configFile >> 'CfgPatches' >> QUOTE(ADDON))), 5];
