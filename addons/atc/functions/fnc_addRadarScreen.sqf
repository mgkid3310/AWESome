...
_screen addAction ["Stop Watching Radar Screen", "player setVariable ['GVAR(isUsingRadarScreen)', false, true];", nil, 1.011, false, true, "", "(isClass (configFile >> 'CfgPatches' >> 'GVAR(environment)')) && (_this getVariable ['GVAR(isUsingRadarScreen)', false])", 5];
