...
if (time > _radarTime + GVAR(radarUpdateInterval)) then {
	...
	private _trailsModeC = [_trailLog, _planesModeC + _heliesModeC, _radarSide, 0] call FUNC(createVehicleTrails);
	...
	private _weaponTrails = [_trailLog, _weaponObjects, _radarSide, 0] call FUNC(createWeaponTrails);

	private _planeMarkersModeC = [_planesModeC, "b_plane", true, _radarSide, 0] call FUNC(createVehicleMarker);
	private _heliMarkersModeC = [_heliesModeC, "b_air", true, _radarSide, 0] call FUNC(createVehicleMarker);
	private _planeMarkersStandBy = [_planesStandBy, "b_plane", false, _radarSide, 0] call FUNC(createVehicleMarker);
	private _heliMarkersStandBy = [_heliesStandBy, "b_air", false, _radarSide, 0] call FUNC(createVehicleMarker);
	...
	private _knownWeaponMarkers = [_knownWeapons, "b_plane", true, _radarSide, 0] call FUNC(createWeaponMarker);
	...
	_antiAirMarkers = [_SAMlaunchers, "b_antiair", false, _radarSide, 0] call FUNC(createAntiAirMarker);
