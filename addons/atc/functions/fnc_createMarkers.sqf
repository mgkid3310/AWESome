...
private _return = [];
{
	...
	_callsign = [name driver _x, groupId group driver _x] select GVAR(displayCallsign);
	...
	_marker0 = createMarkerLocal [format ["GVAR()%1_%2_%3_0", _type, _mode, _forEachIndex], getPos _x];
	_marker0 setMarkerTypeLocal _type;
	_marker0 setMarkerColorLocal "colorBLUFOR";
	_marker0 setMarkerTextLocal "";

	_marker1 = createMarkerLocal [format ["GVAR()%1_%2_%3_1", _type, _mode, _forEachIndex], getPos _x];
	...
	_marker2 = createMarkerLocal [format ["GVAR()%1_%2_%3_2", _type, _mode, _forEachIndex], getPos _x];
	...
	_marker3 = createMarkerLocal [format ["GVAR()%1_%2_%3_3", _type, _mode, _forEachIndex], getPos _x];
	...
	_marker4 = createMarkerLocal [format ["GVAR()%1_%2_%3_4", _type, _mode, _forEachIndex], getPos _x];
