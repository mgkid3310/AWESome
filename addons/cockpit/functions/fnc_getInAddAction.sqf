...
_vehicle addAction ["Next Checklist", {[1] call FUNC(nextChecklist)}, nil, 1.0152, false, true, "", "([_this, _target, 1] call orbis_main_fnc_isCrew) && !('orbis_cockpit_currentChecklist' isEqualTo 'none')", 100];
_vehicle addAction ["Previouse Checklist", {[-1] call FUNC(nextChecklist)}, nil, 1.0153, false, true, "", "([_this, _target, 1] call orbis_main_fnc_isCrew) && !('orbis_cockpit_currentChecklist' isEqualTo 'none')", 100];
