...
switch (_flightphase) do {
    case ("taxing"): {
        if (speed _vehicle > 80) then {
            ...
            DEV_CHAT("awesome_gpws: b747GPWS taxing -> takeOff");
        };
    };
    case ("takeOff"): {
        if ((_altRadar > awesome_gpws_takeoffAlt) || (speed _vehicle > awesome_gpws_takeoffSpeed)) then {
            _flightphase = "inFlight";
            DEV_CHAT("awesome_gpws: b747GPWS takeOff -> inFlight");
        };

	    if (isTouchingGround _vehicle) exitWith {
            _flightphase = "touchDown";
            DEV_CHAT("awesome_gpws: b747GPWS takeOff -> touchDown");
        };
    };
    case ("inFlight"): {
	    _currentILSindex = -1;
	    ...
	    if (isTouchingGround _vehicle) exitWith {
            _flightphase = "touchDown";
            DEV_CHAT("awesome_gpws: b747GPWS inFlight -> touchDown");
        };

        {
            ...
            if ((speed _vehicle < 600) && (_altDiff < 400) && (_distance < 6000) && (_headingDiff < 30) && (_approachAngle < 30) && (_climeASL < 0)) exitWith {
                ...
                DEV_CHAT("awesome_gpws: b747GPWS inFlight -> landing (ILS app.)");
            };
        } forEach awesome_gpws_runwayList;
        ...
        if ((speed _vehicle < 600) && ((_flapStatus > 0.1) || (_gearStatus < 0.9)) && (_altRadar < 400) && (_climeASL < 0)) exitWith {
            _flightphase = "landing";
            _currentILSindex = -1;
            DEV_CHAT("awesome_gpws: b747GPWS inFlight -> landing (visual app.)");
        };
    };
    case ("landing"): {
        if !(_currentILSindex < 0) then {
            _ILSarray = awesome_gpws_runwayList select _currentILSindex;
            ...
            switch (true) do {
                case ((speed _vehicle > 600) || (_altDiff > 400) || (_distance > 6000) || (_headingDiff > 30) || (_approachAngle > 30) || (_climeASL > 5)): {
                    _flightphase = "inFlight";
                    _currentILSindex = -1;
                    DEV_CHAT("awesome_gpws: b747GPWS landing -> inFlight");
                };
                case ((speed _vehicle < 400) && (_altDiff < 100) && (_distance < 1000) && (_headingDiff < 30) && (_approachAngle < 30) && (_climeASL < 0)): {
                    _flightphase = "final";
                    DEV_CHAT("awesome_gpws: b747GPWS landing -> final (ILS app.)");
                };
                case (isTouchingGround _vehicle): {
                    _flightphase = "touchDown";
                    DEV_CHAT("awesome_gpws: b747GPWS landing -> touchDown");
                };
                default {};
            };
        } else {
            switch (true) do {
                ...
                case ((speed _vehicle < 400) && ((_flapStatus > 0.6) || (_gearStatus < 0.9)) && (_altRadar < 100) && (_climeASL < 0)): {
                    _flightphase = "final";
                    DEV_CHAT("awesome_gpws: b747GPWS landing -> final (visual app.)");
                };
                case (isTouchingGround _vehicle): {
                    _flightphase = "touchDown";
                    DEV_CHAT("awesome_gpws: b747GPWS landing -> touchDown");
                ...
                default {
                    {
                        ...
                        if ((_altDiff < 200) && (_distance < 3000) && (_headingDiff < 30) && (_approachAngle < 30)) exitWith {
                            ...
                            DEV_CHAT("awesome_gpws: b747GPWS ILS capture");
                        };
                    } forEach awesome_gpws_runwayList;
                };
            };
        ...
        if !(_currentILSindex < 0) then {
            ...
            switch (true) do {
                case ((_altDiff > 100) || (_distance > 1000) || (_headingDiff > 30) || (_climeASL > 5)): {
                    _flightphase = "inFlight";
                    DEV_CHAT("awesome_gpws: b747GPWS final -> inFLight");
                };
                case (isTouchingGround _vehicle): {
                    _flightphase = "touchDown";
                    DEV_CHAT("awesome_gpws: b747GPWS final -> touchDown");
                };
                default {};
            };
        } else {
    ...
    case ("touchDown"): {
        switch (true) do {
            case (_altRadar > awesome_gpws_takeoffAlt): {
                _flightphase = "inFlight";
                DEV_CHAT("awesome_gpws: b747GPWS touchDown -> inFlight");
            };
            case (speed _vehicle < 50): {
                _flightphase = "taxing";
                DEV_CHAT("awesome_gpws: b747GPWS touchDown -> taxing");
            };
            default {};
        };
    };
