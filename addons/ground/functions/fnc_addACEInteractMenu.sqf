...
/* private _parkingBrakeSet = [
	...
	{([nil, nil, 1] call EFUNC(main,isCrew)) && !(_target getVariable [QGVAR(parkingBrakeSet), false]) && (abs (speed _target) < 1)},
	{},
	[],
	[0, 0, 0],
	10
...
private _parkingBrakeRelease = [
	...
	{([nil, nil, 1] call EFUNC(main,isCrew)) && (_target getVariable [QGVAR(parkingBrakeSet), true])},
	{},
	[],
	[0, 0, 0],
	10
