private _checklistMain = [
	...
	"",
	{},
	{[nil, nil, 1] call orbis_awesome_main_fnc_isCrew},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist01 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "pre_start_checklist")},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist02 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "startup_before_taxi_checklist")},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist03 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "before_takeoff_checklist")},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist04 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "takeoff_checklist")},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist05 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "descent_approach_checklist")},
	{},
	[],
	[0, 0, 0],
	10
...
private _openChecklist06 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && !(orbis_cockpit_currentChecklist isEqualTo "landing_taxi_to_ramp_checklist")},
	{},
	[],
	[0, 0, 0],
	10
