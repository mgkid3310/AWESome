...
_vehicle addAction ["Close Checklist", "['none'] call orbis_cockpit_fnc_openChecklist", nil, 1, false, true, "", "(isClass (configFile >> 'CfgPatches' >> 'orbis_cockpit')) && ([nil, nil, 1] call orbis_gpws_fnc_isCrew) && !(orbis_cockpit_currentChecklist in ['none', 'Default'])", 100];
