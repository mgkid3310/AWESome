...
_vehicle addAction ["Open Checklist", "[orbis_cockpit_lastChecklist] call orbis_cockpit_fnc_openChecklist", nil, 1, false, true, "", "(isClass (configFile >> 'CfgPatches' >> 'orbis_cockpit')) && ([nil, nil, 1] call orbis_awesome_main_fnc_isCrew)", 100];
