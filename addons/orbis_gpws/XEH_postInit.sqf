...
private _actionGPWSmodes = [
	...
	"",
	{},
	{(_target getVariable ['orbisGPWSenabled', false]) && (_player isEqualTo driver _target)},
	{},
	[],
	[0, 0, 0],
	10
...
private _actionTurnOff = [
	...
	{(_target getVariable ['orbisGPWSenabled', false]) && (_player isEqualTo driver _target) && (_target getVariable ['orbisGPWSmode', ''] != '')},
	{},
	[],
	[0, 0, 0],
	10
...
/* private _actionB747 = [
	...
	{(_target getVariable ['orbisGPWSenabled', false]) && (_player isEqualTo driver _target) && (_target getVariable ['orbisGPWSmode', ''] != 'b747')},
	{},
	[],
	[0, 0, 0],
	10
