private _actionGPWSmodes = [
	...
	"",
	{},
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && (_target getVariable ["orbisGPWSenabled", false])},
	{},
	[],
	[0, 0, 0],
	10
...
private _testF16 = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && (_target getVariable ["orbisGPWSenabled", false]) && (_target getVariable ["orbisGPWSmodeLocal", "off"] == "f16") && (_target getVariable ["orbisGPWStestReady", true])},
	{},
	[],
	[0, 0, 0],
	10
...
private _testStop = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && (_target getVariable ["orbisGPWSenabled", false]) && (_target getVariable ["orbisGPWSmodeLocal", "off"] != "off") && !(_target getVariable ["orbisGPWStestReady", true]) && !(_target getVariable ["orbisGPWStestStop", false])},
	{},
	[],
	[0, 0, 0],
	10
...
private _actionVolumeLow = [
	...
	{([nil, nil, 1] call orbis_awesome_main_fnc_isCrew) && (_target getVariable ["orbisGPWSenabled", false]) && !(_target getVariable ["orbisGPWSvolumeLow", false])},
	{},
	[],
	[0, 0, 0],
	10
